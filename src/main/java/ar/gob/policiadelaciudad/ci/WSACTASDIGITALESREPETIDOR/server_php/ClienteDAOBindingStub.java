...
public class ClienteDAOBindingStub extends org.apache.axis.client.Stub implements ar.gob.policiadelaciudad.ci.WSACTASDIGITALESREPETIDOR.server_php.ClienteDAOPort {
    ...
    private static void _initOperationDesc1(){
        ...
        oper.setName("TestWS");
        oper.setReturnType(new javax.xml.namespace.QName("https://ci.policiadelaciudad.gob.ar/WSACTASDIGITALESREPETIDOR/server.php", "Existe"));
        ...
        oper.addParameter(param);
        oper.setReturnType(new javax.xml.namespace.QName("https://ci.policiadelaciudad.gob.ar/WSACTASDIGITALESREPETIDOR/server.php", "Usuario"));
    ...
    public ClienteDAOBindingStub() throws org.apache.axis.AxisFault {
         this(null);
    }

    public ClienteDAOBindingStub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
         this(service);
         super.cachedEndpoint = endpointURL;
    }

    public ClienteDAOBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        if (service == null) {
        ...
        ((org.apache.axis.client.Service)super.service).setTypeMappingVersion("1.2");
            ...
            qName = new javax.xml.namespace.QName("https://ci.policiadelaciudad.gob.ar/WSACTASDIGITALESREPETIDOR/server.php", "Existe");
            ...
            qName = new javax.xml.namespace.QName("https://ci.policiadelaciudad.gob.ar/WSACTASDIGITALESREPETIDOR/server.php", "Usuario");
            cachedSerQNames.add(qName);
    ...
    public ar.gob.policiadelaciudad.ci.WSACTASDIGITALESREPETIDOR.server_php.Existe testWS() throws java.rmi.RemoteException {
        ...
        _call.setSOAPActionURI("https://ci.policiadelaciudad.gob.ar/WSACTASDIGITALESREPETIDOR/server.php#TestWS");
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("https://ci.policiadelaciudad.gob.ar/WSACTASDIGITALESREPETIDOR/server.php", "TestWS"));
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {});
  ...
  throw axisFaultException;
    ...
    public ar.gob.policiadelaciudad.ci.WSACTASDIGITALESREPETIDOR.server_php.Usuario validarAcc(java.lang.String usu, java.lang.String clv, java.lang.String pc) throws java.rmi.RemoteException {
        ...
        _call.setUseSOAPAction(true);
        _call.setSOAPActionURI("https://ci.policiadelaciudad.gob.ar/WSACTASDIGITALESREPETIDOR/server.php#validarAcc");
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("https://ci.policiadelaciudad.gob.ar/WSACTASDIGITALESREPETIDOR/server.php", "validarAcc"));
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {usu, clv, pc});
    System.out.println("========== _resp = " + _resp );
     ...
     System.out.println("=============== Error axisFaultException " + axisFaultException.getMessage());
